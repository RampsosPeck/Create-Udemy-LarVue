                                    ...
                                    <td>
                                        <button type="button" class="btn btn-warning btn-sm" @click="abrirModal('articulo','actualizar',articulo)">
                                         ...
                                         <template v-if="articulo.condicion">
                                            <button type="button" class="btn btn-danger btn-sm" @click="desactivarArticulo(articulo.id)"><i class="icon-trash">Desactivar</i></button>
                                         </template>
                                         <template v-else>
                                            <button type="button" class="btn btn-info btn-sm" @click="activarArticulo(articulo.id)"><i class="icon-check">Activar</i></button>
                                         </template>
                                    </td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div v-show="errorArticulo" class="row form-group">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==2"  class="btn btn-info" @click="actualizarArticulo()">Actualizar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
        ...
        methods: {
            ...
            desactivarArticulo(id){
                ...
                swalWithBootstrapButtons.fire({
                  title: 'Estás seguro?',
                  text: "Quieres desactivar el articulo!",
                  type: 'warning',
            ...
            activarArticulo(id){
                ...
                swalWithBootstrapButtons.fire({
                  title: 'Estás seguro?',
                  text: "Quieres activar el articulo!",
                  type: 'warning',
                  showCancelButton: true,
                  confirmButtonText: 'Si, borralo!',
                  cancelButtonText: 'No, cancelar!',
            ...
            validarArticulo(){
                ...
                if(!this.stock) this.errorMostrarMsjArticulo.push("El stock del articulo no puede estar vacio");
                if(!this.precio_venta) this.errorMostrarMsjArticulo.push("El precio de venta del articulo no puede estar vacio");
